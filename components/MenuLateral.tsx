...
export default function BoxResultado(props: any) {
  ...
  return (
    <div className={styles.container}>
        <div className={styles.divFitroAberto}>
            ...
            <Link type="submit" href={"&raca:" + racaPesquisa + "&loc:" + localPesquisa + "&valmin:" + precoMinPesquisa + "&valmax:" + precoMaxPesquisa} className={styles.buttonPesquisa}>
                adicionar filtro!
            </Link>
            </div>
        </div>
